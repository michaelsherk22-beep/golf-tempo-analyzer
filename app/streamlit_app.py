...
st.title("🏌️ Golf Swing Tempo Analyzer (MVP)")
st.write("Upload a swing video. This MVP estimates **Address → Top → Impact** and computes tempo ratio.")
...
if uploaded:
    ...
    st.caption("Note: MVP heuristic event detection. Future improvements: use velocity peaks, annotate video, handedness toggle.")
