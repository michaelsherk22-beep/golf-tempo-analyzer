...
st.set_page_config(page_title="Golf Swing Tempo Analyzer (Auto)", layout="centered")
...
max_frames = st.slider("Max frames to analyze", 60, 600, 240, 30)
hand = st.selectbox("Handedness", ["right", "left"], index=0)
...
if uploaded:
    ...
    with st.spinner("Extracting pose keypoints..."):
        ...
        y = wrist_y_series(poses, handedness=hand)
